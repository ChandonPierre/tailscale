...
type endpoint struct {
	...
	lastRecvWG            mono.Time // last time there were incoming wireguard-go destined packets from this peer
...
type probeUDPLifetime struct {
	...
	// config holds the probing configuration. It must be non-nil.
